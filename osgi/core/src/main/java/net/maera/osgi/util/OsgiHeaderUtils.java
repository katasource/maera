...
/**
 * TODO - this is a horrible mess - create a more OO construct (Les, 14 Sept 2010)
 * 
 * Utilities to help create OSGi headers.
 *
 * @since 0.1
 */
public class OsgiHeaderUtils {

    public static final String JDK_PACKAGES_PATH = "jdk-packages.txt";
    public static final String JDK6_PACKAGES_PATH = "jdk6-packages.txt";

    public static final String MAERA_PLUGIN_KEY = "Maera-Plugin-Key";

    static Logger log = LoggerFactory.getLogger(OsgiHeaderUtils.class);
     ...
     * @throws java.io.IOException If there are any problems scanning bytecode
     * @since 2.4.0
     *
    ...
    static void crawlReferenceTree(String className, Set<String> scannedClasses, Set<String> packageImports, int level) throws IOException {
        ...
        InputStream in = null;
        try {
            in = ClassLoaderUtils.getResourceAsStream(className, OsgiHeaderUtils.class);
     ...
     * <p/>
     * WARNING: shamelessly copied at {@code org.maera.plugin.osgi.bridge.PluginBundleUtils}, which can't use
    ...
    public static String getPluginKey(Bundle bundle) {
        return getPluginKey(
                ...
                bundle.getHeaders().get(MAERA_PLUGIN_KEY),
    ...
    public static String getPluginKey(Manifest mf) {
        return getPluginKey(
                ...
                mf.getMainAttributes().getValue(MAERA_PLUGIN_KEY),
